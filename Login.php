...
<body>
    <div class="all">
        ...
        <?php } ?>
        <div class="logo">
            <img id="logo" src="mobile logo.png" alt="Frontendfortress logo">
        </div>
        ...
        <div class="login">
            ...
            <div class="bottom">
                <div class="register">
                    <p class="bots">Don’t have an account? <br><a href="#">Register</a></p>
                </div>
                <div class="register1">
                    <p class="bots">Don’t have an account? <a href="#">Register</a></p>
                </div>
